...
/*!
 * \brief Класс Encoder1611 реализует алгоритм перевода последовательности бит в код Хэмминга 16-11.
 * \author Wb2D
 * \date 2 октября 2023
 * \details Данный класс разбивает битовую последовательность на части и кодирует каждую часть
 * по алгоритму кода Хэмминга 16-11. В случае, если размерность превышает 11, последовательность 
